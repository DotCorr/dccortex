...
export { WEATHER_APP_TEMPLATE } from './weather-app-layout'
export { POSTS_BROWSER_TEMPLATE } from './posts-browser-layout'
export { PHOTO_GALLERY_TEMPLATE } from './photo-gallery-layout'
...
import { PHOTO_GALLERY_TEMPLATE } from './photo-gallery-layout'
...
export const ALL_TEMPLATES = [
  ...
  PRODUCTS_CATALOG_TEMPLATE,
  POSTS_BROWSER_TEMPLATE,

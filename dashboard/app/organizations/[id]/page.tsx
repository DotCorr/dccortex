...
import { Users, FolderKanban, Plus, Mail, X, UserPlus, ArrowRight, FileText, Settings, CheckCircle, Trash2, Send, Copy, Sparkles, Pencil, Bot, Key, ChevronDown, ChevronUp } from 'lucide-react'
...
export default function OrganizationDetailPage() {
  ...
  const visibleTemplates = ALL_TEMPLATES.filter(
    (template) => template.name === 'Weather Dashboard' || template.name === 'Incident Command Center'
  )

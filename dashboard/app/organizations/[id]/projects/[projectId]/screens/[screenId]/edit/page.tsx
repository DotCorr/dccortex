...
import type { EventActionConfig, EventRuntimeContext, AnimationSequenceConfig } from '@dccortex/runtime-kernel'
...
import CortexPanel from '@/components/cortex/Cortex'
...
export default function ScreenEditPage() {
  ...
  const [leftPanelTab, setLeftPanelTab] = useState<'layers' | 'screens' | 'ai' | 'console'>('layers')
            ...
            <div className="flex flex-col h-full min-h-0">
              ...
              <div className="shrink-0 flex border-b border-gray-200 dark:border-[#30363d] bg-white dark:bg-[#161b22]">
                ...
                <button
                  ...
                  className={`flex-1 px-2 py-2 text-xs font-medium transition-colors ${leftPanelTab === 'ai' ? 'text-black dark:text-white border-b-2 border-[var(--primary)]' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200'}`}
                >
                  AI
                </button>
                <button
                  ...
                  className={`flex-1 px-2 py-2 text-xs font-medium transition-colors ${leftPanelTab === 'console' ? 'text-black dark:text-white border-b-2 border-[var(--primary)]' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200'}`}
                >
                  Console
                </button>
              </div>
          ...
          center={
            <div className="flex flex-col flex-1 min-w-0 min-h-0 overflow-hidden">
              ...
              <div className={`flex-1 min-w-0 min-h-0 overflow-hidden ${showGeneratedSource && !previewMode ? 'grid grid-cols-1 xl:grid-cols-2' : ''}`}>
                <div ref={canvasStageRef} className={`min-w-0 min-h-0 ${canvasExpanded ? 'overflow-hidden' : 'overflow-auto'} flex flex-col items-start justify-start ${showGeneratedSource && !previewMode ? 'border-r border-gray-200 dark:border-[#30363d]' : 'flex-1'}`}>
                  {(() => {
                  const liveFitScale =

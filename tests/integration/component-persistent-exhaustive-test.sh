...
delete_project() {
  : # no-op in persistent exhaustive mode
}
...
echo -e "  ${GREEN}✓${NC} Using fixed org $SHARED_ORG_ID"
PASS=$((PASS + 1))
...
get_or_create_project() {
  local name="$1"
  local projects_resp existing_id create_resp proj_id
  projects_resp=$(api_get "/api/projects?organizationId=${SHARED_ORG_ID}")
  existing_id=$(echo "$projects_resp" | jq -r --arg n "$name" '.projects[]? | select(.name == $n) | .id' | head -n1)
  if [[ -n "$existing_id" ]]; then
    echo "$existing_id"
    return 0
  fi
  create_resp=$(api_post "/api/projects" "{\"name\":\"${name}\",\"organizationId\":\"${SHARED_ORG_ID}\"}")
  proj_id=$(echo "$create_resp" | jq -r '.project.id // empty')
  if [[ -z "$proj_id" ]]; then
    echo "Failed to create project: $name" >&2
    echo "$create_resp" >&2
    exit 1
  fi
  echo "$proj_id"
...
reset_project_screens() {
  local proj_id="$1"
  local screens_resp sid
  screens_resp=$(api_get "/api/projects/${proj_id}/screens")
  while IFS= read -r sid; do
    [[ -z "$sid" ]] && continue
    api_delete "/api/projects/${proj_id}/screens/${sid}" > /dev/null 2>&1 || true
  done < <(echo "$screens_resp" | jq -r '.screens[]?.id' 2>/dev/null)
}
...
C_PROJ=$(get_or_create_project "Container Test")
reset_project_screens "$C_PROJ"
echo -e "  ${GREEN}✓${NC} Using persistent project Container Test ($C_PROJ)"
...
echo -e "  ${GREEN}✓${NC} Container project retained for inspection"
PASS=$((PASS + 1))
...
T_PROJ=$(get_or_create_project "Text Test")
reset_project_screens "$T_PROJ"
echo -e "  ${GREEN}✓${NC} Using persistent project Text Test ($T_PROJ)"
...
echo -e "  ${GREEN}✓${NC} Text project retained for inspection"
PASS=$((PASS + 1))
...
B_PROJ=$(get_or_create_project "Button Test")
reset_project_screens "$B_PROJ"
echo -e "  ${GREEN}✓${NC} Using persistent project Button Test ($B_PROJ)"
...
echo -e "  ${GREEN}✓${NC} Button project retained for inspection"
PASS=$((PASS + 1))
...
S_PROJ=$(get_or_create_project "Stack Test")
reset_project_screens "$S_PROJ"
echo -e "  ${GREEN}✓${NC} Using persistent project Stack Test ($S_PROJ)"
...
echo -e "  ${GREEN}✓${NC} Stack project retained for inspection"
PASS=$((PASS + 1))
...
CD_PROJ=$(get_or_create_project "Card Test")
reset_project_screens "$CD_PROJ"
echo -e "  ${GREEN}✓${NC} Using persistent project Card Test ($CD_PROJ)"
...
echo -e "  ${GREEN}✓${NC} Card project retained for inspection"
PASS=$((PASS + 1))
...
I_PROJ=$(get_or_create_project "Image Test")
reset_project_screens "$I_PROJ"
echo -e "  ${GREEN}✓${NC} Using persistent project Image Test ($I_PROJ)"
...
echo -e "  ${GREEN}✓${NC} Image project retained for inspection"
PASS=$((PASS + 1))
...
BD_PROJ=$(get_or_create_project "Badge Test")
reset_project_screens "$BD_PROJ"
echo -e "  ${GREEN}✓${NC} Using persistent project Badge Test ($BD_PROJ)"
...
echo -e "  ${GREEN}✓${NC} Badge project retained for inspection"
PASS=$((PASS + 1))
...
CK_PROJ=$(get_or_create_project "Checkbox Test")
reset_project_screens "$CK_PROJ"
echo -e "  ${GREEN}✓${NC} Using persistent project Checkbox Test ($CK_PROJ)"
...
echo -e "  ${GREEN}✓${NC} Checkbox project retained for inspection"
PASS=$((PASS + 1))
...
TG_PROJ=$(get_or_create_project "Toggle Test")
reset_project_screens "$TG_PROJ"
echo -e "  ${GREEN}✓${NC} Using persistent project Toggle Test ($TG_PROJ)"
...
echo -e "  ${GREEN}✓${NC} Toggle project retained for inspection"
PASS=$((PASS + 1))
...
FI_PROJ=$(get_or_create_project "FormInput Test")
reset_project_screens "$FI_PROJ"
echo -e "  ${GREEN}✓${NC} Using persistent project FormInput Test ($FI_PROJ)"
...
echo -e "  ${GREEN}✓${NC} FormInput project retained for inspection"
PASS=$((PASS + 1))
...
SI_PROJ=$(get_or_create_project "Selection Test")
reset_project_screens "$SI_PROJ"
echo -e "  ${GREEN}✓${NC} Using persistent project Selection Test ($SI_PROJ)"
...
echo -e "  ${GREEN}✓${NC} Selection project retained for inspection"
PASS=$((PASS + 1))
...
DI_PROJ=$(get_or_create_project "Display Test")
reset_project_screens "$DI_PROJ"
echo -e "  ${GREEN}✓${NC} Using persistent project Display Test ($DI_PROJ)"
...
echo -e "  ${GREEN}✓${NC} Display project retained for inspection"
PASS=$((PASS + 1))
...
AV_PROJ=$(get_or_create_project "Avatar Test")
reset_project_screens "$AV_PROJ"
echo -e "  ${GREEN}✓${NC} Using persistent project Avatar Test ($AV_PROJ)"
...
echo -e "  ${GREEN}✓${NC} Avatar project retained for inspection"
PASS=$((PASS + 1))
...
PB_PROJ=$(get_or_create_project "ProgressBar Test")
reset_project_screens "$PB_PROJ"
echo -e "  ${GREEN}✓${NC} Using persistent project ProgressBar Test ($PB_PROJ)"
...
echo -e "  ${GREEN}✓${NC} ProgressBar project retained for inspection"
PASS=$((PASS + 1))
...
AB_PROJ=$(get_or_create_project "AlertBanner Test")
reset_project_screens "$AB_PROJ"
echo -e "  ${GREEN}✓${NC} Using persistent project AlertBanner Test ($AB_PROJ)"
...
echo -e "  ${GREEN}✓${NC} AlertBanner project retained for inspection"
PASS=$((PASS + 1))
...
TB_PROJ=$(get_or_create_project "Tabs Test")
reset_project_screens "$TB_PROJ"
echo -e "  ${GREEN}✓${NC} Using persistent project Tabs Test ($TB_PROJ)"
...
echo -e "  ${GREEN}✓${NC} Tabs project retained for inspection"
PASS=$((PASS + 1))
...
TBL_PROJ=$(get_or_create_project "Table Test")
reset_project_screens "$TBL_PROJ"
echo -e "  ${GREEN}✓${NC} Using persistent project Table Test ($TBL_PROJ)"
...
echo -e "  ${GREEN}✓${NC} Table project retained for inspection"
PASS=$((PASS + 1))
...
DR_PROJ=$(get_or_create_project "DataRepeater Test")
reset_project_screens "$DR_PROJ"
echo -e "  ${GREEN}✓${NC} Using persistent project DataRepeater Test ($DR_PROJ)"
...
echo -e "  ${GREEN}✓${NC} DataRepeater project retained for inspection"
PASS=$((PASS + 1))
...
LK_PROJ=$(get_or_create_project "Link Test")
reset_project_screens "$LK_PROJ"
echo -e "  ${GREEN}✓${NC} Using persistent project Link Test ($LK_PROJ)"
...
echo -e "  ${GREEN}✓${NC} Link project retained for inspection"
PASS=$((PASS + 1))
...
MO_PROJ=$(get_or_create_project "Modal Test")
reset_project_screens "$MO_PROJ"
echo -e "  ${GREEN}✓${NC} Using persistent project Modal Test ($MO_PROJ)"
...
echo -e "  ${GREEN}✓${NC} Modal project retained for inspection"
PASS=$((PASS + 1))
...
SP_PROJ=$(get_or_create_project "Spinner Test")
reset_project_screens "$SP_PROJ"
echo -e "  ${GREEN}✓${NC} Using persistent project Spinner Test ($SP_PROJ)"
...
echo -e "  ${GREEN}✓${NC} Spinner project retained for inspection"
PASS=$((PASS + 1))
...
GT_PROJ=$(get_or_create_project "Gradient Test")
reset_project_screens "$GT_PROJ"
echo -e "  ${GREEN}✓${NC} Using persistent project Gradient Test ($GT_PROJ)"
...
echo -e "  ${GREEN}✓${NC} Gradient project retained for inspection"
PASS=$((PASS + 1))
...
SL_PROJ=$(get_or_create_project "Semantic Layout Test")
reset_project_screens "$SL_PROJ"
echo -e "  ${GREEN}✓${NC} Using persistent project Semantic Layout Test ($SL_PROJ)"
...
echo -e "  ${GREEN}✓${NC} Semantic layout project retained for inspection"
PASS=$((PASS + 1))
...
SC_PROJ=$(get_or_create_project "Specialty Test")
reset_project_screens "$SC_PROJ"
echo -e "  ${GREEN}✓${NC} Using persistent project Specialty Test ($SC_PROJ)"
...
echo -e "  ${GREEN}✓${NC} Specialty project retained for inspection"
PASS=$((PASS + 1))
...
SU_PROJ=$(get_or_create_project "Suspense Test")
reset_project_screens "$SU_PROJ"
echo -e "  ${GREEN}✓${NC} Using persistent project Suspense Test ($SU_PROJ)"
...
echo -e "  ${GREEN}✓${NC} Suspense project retained for inspection"
PASS=$((PASS + 1))
...
GD_PROJ=$(get_or_create_project "GestureDetector Test")
reset_project_screens "$GD_PROJ"
echo -e "  ${GREEN}✓${NC} Using persistent project GestureDetector Test ($GD_PROJ)"
...
echo -e "  ${GREEN}✓${NC} GestureDetector project retained for inspection"
PASS=$((PASS + 1))
...
RT_PROJ=$(get_or_create_project "RichText Test")
reset_project_screens "$RT_PROJ"
echo -e "  ${GREEN}✓${NC} Using persistent project RichText Test ($RT_PROJ)"
...
echo -e "  ${GREEN}✓${NC} RichText project retained for inspection"
PASS=$((PASS + 1))
...
INT_PROJ=$(get_or_create_project "Integration Test")
reset_project_screens "$INT_PROJ"
echo -e "  ${GREEN}✓${NC} Using persistent project Integration Test ($INT_PROJ)"
...
echo -e "  ${GREEN}✓${NC} Integration project retained for inspection"
PASS=$((PASS + 1))
